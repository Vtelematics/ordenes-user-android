...
public class CFFiltersDB extends SQLiteOpenHelper {

   private final static String name = "CfFiltersDataBase";
   private final static int version = 1;
   private final static String TABLE_NAME = "cf_filters_table";
   ...
   private static CFFiltersDB sInstance;

   public static synchronized CFFiltersDB getInstance(Context context) {
      if (sInstance == null) {
         sInstance = new CFFiltersDB(context.getApplicationContext());
      }
      return sInstance;
   }

   private CFFiltersDB(Context context) {
